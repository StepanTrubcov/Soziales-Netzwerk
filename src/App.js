  ...
  return (
    ...
    <div className="app-wrapper">
      ...
      <div className="app-wrapper-content">
        <Routes>
      <Route path="/profile/*"  element={<Profile postData={props.state.profilePage} addPost={props.addPost} newPostText={props.state.profilePage.newPostText} newPostImg={props.state.profilePage.newPostImg} updateNewPostText={props.updateNewPostText} updateNewPostImg={props.updateNewPostImg}/>} />
      <Route path="/dialogs/*" element={<Dialogs dialogsData={props.state.messagesPage.dialogsData} messagesData={props.state.messagesPage.messagesData} addMessage={props.addMessage} updateNewMessageText={props.updateNewMessageText}/>} />
